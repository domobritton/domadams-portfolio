    ...
    <div className="scroll">
      ...
      <div className="portfolio">
        <div className="left">
          ...
          <p>
            <em>Technologies: Rails, React, Webpack, AWS S3 ActiveStorage</em>
          </p>
          <ul>
            <li>
              Formulated a Javascript algorithm that resizes individual masonry
              blocks and optimizes their positioning within a masonry grid,
              depending on image size and available screen width.
            </li>
            <li>
              I also designed an infinite scroll which initially fills the
              browser with images and continuously listens for scroll events in
              order to execute seamless AJAX requests.
            </li>
            <li>
              A higher order component handles modal functionality which can be
              passed to other components as needed untilizing the UI slice of
              state.
            </li>
          </ul>
          ...
          <ul>
            <li>
              ...
              known for creating unique silent disco experiences across America.
              I built this website in Wordpress, to replace an older site in
              need of updating.
            </li>
          </ul>
          <div className="portfolio-links">
          ...
          <p>
            <em>Technologies: Node JS, Express, Pusher, Dark Sky API, Axios</em>
          </p>
          <ul>
            <li>
            ...
            <li>
              ...
              randomly generated points; to simulate a galaxy of stars in the
              browser window.
            </li>
            <li>
              Applied CSS animations with keyframes to generate a “twinkling”
              effect on stars.
            </li>
          </ul>
          <div className="portfolio-links">
        ...
        <div className="right">
          ...
          <ul>
            <li>
              Collaborated VP's of Design and Product to design a new website
              for their robotic clothing company, focusing on a clean and easy
              to use experience with forward-thinking CSS and interface design.
            </li>
            <li>
